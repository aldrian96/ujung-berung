...
<div class="col-md-12">
                ...
                <tbody>
                    ...
                    <?php foreach ($daftar_item as $item) { ?>
                        <tr>
                            ...
                            <td width="50"><button data-kode="<?php echo $item->kd_model ?>" class="btn btn-primary btn-xs btn-edit"><span class="glyphicon glyphicon-edit"></span></a></td>
    ...
    <a class="btn btn-success" href="<?php echo site_url('report'); ?>" role="button"><i class="fa fa-file-excel-o"></i>
        Export to Excel</a>
</div>
<?php echo $this->pagination->create_links(); ?>